...
Это так называемый коренной файл настроек, которые загружается вместе с ботом.
...
- `BOT_PREFIX`: **Прекфикс**.
  Префикс используется перед каждым именеим команды бота.
  Это нужно чтобы бот понимал что команды предназначаются именно ему.
  Вместо префикса вы также можете упомянуть бота.

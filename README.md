...
<p align="center">
    ...
    <img alt="Discord" src="https://img.shields.io/discord/1268922475714969690?logo=discord&label=Discord&color=%230066ff">
</p>
...
> Обратите внимание что для работы некоторый расширений трубеются другие
> расписания и бибилиотеки.
>
> Так например, для работы экономики (`coiningine`) требуется расширение
> `coins`.

```
├── assets      - Некоторые медиафайлы репозитория (документация?)
├── chioricord  - Ядро бота: загрузчик плагинов, хранилище настроек.
├── exstensions - Расширения, предоставляющие больше возможностей для бота.
...
соотвутствующем **разделе форуме** в Discord сервера (ссылка выше).
